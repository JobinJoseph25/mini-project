...
<div class="body-content">
  <div class="module">
    ...
    <form class="form" action="addvehicle.php"  method="POST" enctype="multipart/form-data" autocomplete="off">
      <div class="alert alert-error"></div>
      <input type="text" placeholder="Model Name" name="modelname" required />
      <input type="text" placeholder="Model NO" name="modelno" required />
    <input type="text" placeholder="Build Year" name="buildyear" required />
    <label>Type</label>
    <select  name="vehicletype">
            <option value="Two Wheeler" >Two Wheeler</option>
            <option value="Four Wheeler">Four Wheeler</option></select>

      <div class="avatar"><label>Image: </label>
        <input type="file" name="imgpath" accept="image/*" value="" required /></div>
      <input type="submit" value="ADD Vehicle" name="Click04" class="btn btn-block btn-primary" />
    </form>
  </div>
</div>
...
// check if the user has clicked the button "UPLOAD" 
    ...
    $sql="INSERT INTO tbladdvehicle(usrid, model_name, model_no, Build_year, Type, imgpath)
     VALUES (' $userid','$modelname','$modelno',' $buildyear','$vehicletype','$imgpath')";
